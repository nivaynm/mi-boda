  ...
  return (
    <div style={{ minHeight:"100vh", background:"#fdf6f0", fontFamily:"Georgia, serif", padding:"50px 20px 100px" }}>
      ...
      <div style={{ textAlign:"center", marginBottom:"36px" }}>
        <p style={{ color:"#b89a7a", letterSpacing:"4px", fontSize:"12px", margin:"0 0 8px" }}>DÓNDE CELEBRAMOS</p>
      ...
      <div style={{ maxWidth:"480px", margin:"0 auto" }}>
        ...
        <div style={{ background:"white", border:"1px solid #e8d5c4", borderRadius:"14px", padding:"20px 24px" }}>
          ...
          <p style={{ color:"#b89a7a", letterSpacing:"3px", fontSize:"11px", textAlign:"center", margin:"0 0 14px" }}>AUTOBÚS PARA INVITADOS</p>

          <div style={{ display:"flex", justifyContent:"space-around", marginBottom:"14px" }}>
            <div style={{ textAlign:"center" }}>
              <div style={{ fontSize:"11px", color:"#b89a7a", marginBottom:"4px" }}>IDA</div>
            ...
            <div style={{ textAlign:"center" }}>
              <div style={{ fontSize:"11px", color:"#b89a7a", marginBottom:"4px" }}>VUELTA</div>
          ...
          <div style={{ background:"#fdf6f0", borderRadius:"10px", padding:"12px 16px", fontSize:"13px", color:"#7a5c4a", lineHeight:"1.6", textAlign:"center" }}>
            Salida desde la estación de <strong>Plaza Castilla</strong><br/>
            Para invitados sin coche. Apúntate al confirmar asistencia.
          </div>
        </div>
