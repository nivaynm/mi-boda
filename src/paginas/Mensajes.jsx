  ...
  return (
    <div style={{ minHeight:"100vh", background:"#fdf6f0", fontFamily:"Georgia, serif", padding:"50px 20px 100px" }}>
      ...
      <div style={{ textAlign:"center", marginBottom:"36px" }}>
        <p style={{ color:"#b89a7a", letterSpacing:"4px", fontSize:"12px", margin:"0 0 8px" }}>DEJADNOS VUESTRAS PALABRAS</p>
        <h2 style={{ color:"#4a3728", fontSize:"28px", fontWeight:"normal", margin:"0 0 10px" }}>Muro de mensajes</h2>
        <p style={{ fontSize:"14px", color:"#7a5c4a", margin:0 }}>Escríbenos una felicitación o un deseo para nuestra nueva vida juntos 💬</p>
      </div>
      ...
      <div style={{ maxWidth:"480px", margin:"0 auto" }}>
        ...
        <div style={{ background:"white", border:"1px solid #e8d5c4", borderRadius:"14px", padding:"24px", marginBottom:"24px" }}>
          <p style={{ color:"#b89a7a", letterSpacing:"3px", fontSize:"11px", margin:"0 0 14px" }}>ESCRIBE TU MENSAJE</p>
          ...
          <textarea
            placeholder="Escribe tu felicitación, deseo o mensaje para los novios..."
            value={mensaje}
          ...
          {enviado && (
            <p style={{ color:"#b89a7a", fontSize:"13px", textAlign:"center", margin:"0 0 10px" }}>
          ...
          <button
            ...
            style={{
              width:"100%",
              background: nombre.trim() && mensaje.trim() ? "#4a3728" : "#e8d5c4",
              color: nombre.trim() && mensaje.trim() ? "white" : "#b89a7a",
              border:"none",
              borderRadius:"30px",
              padding:"14px",
              fontSize:"15px",
              cursor: nombre.trim() && mensaje.trim() ? "pointer" : "not-allowed",
              fontFamily:"Georgia, serif"
            }}>
