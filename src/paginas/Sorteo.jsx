    ...
    return (
      <div style={{ minHeight:"100vh", background:"#fdf6f0", fontFamily:"Georgia, serif", display:"flex", alignItems:"center", justifyContent:"center", padding:"20px" }}>
        <div style={{ background:"white", border:"1px solid #e8d5c4", borderRadius:"14px", padding:"36px 28px", maxWidth:"360px", width:"100%", textAlign:"center" }}>
          ...
          <h2 style={{ color:"#4a3728", fontWeight:"normal", fontSize:"22px", margin:"0 0 8px" }}>Panel de sorteo</h2>
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#fdf6f0", fontFamily:"Georgia, serif", padding:"50px 20px 100px" }}>
      <div style={{ textAlign:"center", marginBottom:"36px" }}>
        ...
        <h2 style={{ color:"#4a3728", fontSize:"28px", fontWeight:"normal", margin:"0 0 10px" }}>Panel de sorteo 🏆</h2>
        <p style={{ fontSize:"14px", color:"#7a5c4a", margin:0 }}>Invitados con 3 o más misiones completadas</p>
      </div>
      ...
      <div style={{ maxWidth:"480px", margin:"0 auto" }}>
        ...
        <div style={{ background:"white", border:"1px solid #e8d5c4", borderRadius:"14px", padding:"24px", marginBottom:"16px" }}>
          ...
          {participantes.length === 0 ? (
            <p style={{ color:"#7a5c4a", fontSize:"14px", textAlign:"center", margin:0 }}>
              Aún no hay participantes con 3 o más misiones completadas
            </p>
          ) : (
        ...
        <button
          onClick={sortear}
          disabled={participantes.length < 2 || sorteando}
          style={{
            width:"100%",
            background: participantes.length >= 2 ? "#4a3728" : "#e8d5c4",
            color: participantes.length >= 2 ? "white" : "#b89a7a",
            border:"none",
            borderRadius:"30px",
            padding:"16px",
            fontSize:"16px",
            cursor: participantes.length >= 2 ? "pointer" : "not-allowed",
            fontFamily:"Georgia, serif",
            marginBottom:"16px"
          }}>
          {sorteando ? "Sorteando... 🎲" : "¡Sortear 2 ganadores! 🏆"}
        </button>
        ...
        {ganadores.length > 0 && (
          <div style={{ background:"#4a3728", borderRadius:"14px", padding:"28px 24px", textAlign:"center" }}>
            ...
            <p style={{ color:"#e8d5c4", letterSpacing:"3px", fontSize:"11px", margin:"0 0 16px" }}>GANADORES</p>
            {ganadores.map((g, i) => (
              <div key={i} style={{ background:"rgba(255,255,255,0.1)", borderRadius:"10px", padding:"14px", marginBottom:"10px" }}>
                ...
                <p style={{ color:"#b89a7a", fontSize:"13px", margin:0 }}>{g.completadas} misiones completadas</p>
              </div>
            ))}
          </div>
        )}
